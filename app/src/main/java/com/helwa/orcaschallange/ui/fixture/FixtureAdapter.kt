...
import com.helwa.orcaschallange.databinding.TeamItemBinding
import com.helwa.orcaschallange.ui.teamDetails.TeamDetailsActivity
...
class FixtureAdapter(val onFavouriteClickListener: OnFavouriteClickListener) :
    ...
    inner class FixtureHolder(private val mBinding: TeamItemBinding) :
        ...
        override fun onItemClicked(teamId: Int) = mBinding.root.context.startActivity(Intent(mBinding.root.context,
            TeamDetailsActivity::class.java).putExtra("teamId",teamId))
